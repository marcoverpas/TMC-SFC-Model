################################################################################
# A TMC-SFC Model - EJEPP version
#
# Author: Marco Veronese Passarella
#
# Last change: 07/06/2022
#
# Note: this R code reproduces the experiments discussed in: Veronese Passarella, M.
# (2022) "It is not la vie en rose. New insights from Graziani's theory of monetary 
# circuit", European Journal of Economics and Economic Policies: Intervention, 2022.
#
################################################################################
...
data00 <- read.csv("https://www.dropbox.com/s/sze12g5988qkvpf/data00web.csv?dl=1") 
...
for (j in 1:nScenarios){
  ...
  for (i in 2:nPeriods){
    ...
    for (iterations in 1:200){
      ...
      paym_l[j,i] = rl[j,i-1]*ld[j,i-1] + iota[j,i]*(mw[j,i-1]/mh[j,i-1])*rl[j,i-1]*fin_f[j,i-1]/2   #Interest payments on bank loans (including average interest payments on repaid share of loans)
...
#Figure 2a
plot(y_r[2,2:100],type="l",col=1,lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(a) Production, consumption, and investment",ylab = '$ (const. p)',xlab = '',ylim=range(min(id[2,2:100]),max(y_r[2,2:100])))
...
legend("right",c("Real output","Real consumption","Real investment"),  bty = "n", cex =1, lty=c(1,1,1), lwd=c(2,2,2,1), col = c(1,2,3), box.lwd=0)

#Figure 2b
plot(fin_i[2,2:100],type="l",col=4,lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(b) The monetary circuit",ylab = '$ (flow)',xlab = '',ylim=range(min(fin_i[2,2:100]),max(fin_i[2,2:100])))
...
legend("bottomright",c("Initial finance","Final finance","Outstanding debt (right axis)"),  bty = "n", cex =1, lty=c(1,2,1), lwd=c(2,2,2,1), col = c(4,5,8), box.lwd=0)

#Figure 2c
plot(p[1,2:100],type="l",col=2,lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(c) Price level",ylab = '$',xlab = '',ylim=range(0.97,1.03))
legend("bottomright",c("Unit price of output"),  bty = "n", cex =1, lty=c(1), lwd=c(2), col = c(2), box.lwd=0)

#Figure 2d
plot(100*cw_r[2,2:100]/cw_r[1,2:100],type="l",col="purple",lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(d) Real consumption of workers",ylab = 'Index',xlab = '',ylim=range(100,110))
...
legend("right",c("Actual","Expected","Planned"),  bty = "n", cex =1, lty=c(1,2,3), lwd=c(2,2,2), col = c("purple","orange","red1"), box.lwd=0)
...
#Figure 3a
plot(100*y_r[3,2:100]/y_r[1,2:100],type="l",col=1,lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(a) Production, consumption, and investment (real)",ylab = 'Index',xlab = '',ylim=range(96,126))
...
legend("topright",c("Output","Workers' consumption","Capitalists' consumption","Real investment"),  bty = "n", cex =1, lty=c(1,1,1,1), lwd=c(2,2,2,2), col = c(1,2,3,4), box.lwd=0)

#Figure 3b
plot(100*fin_i[3,2:100]/fin_i[1,2:100],type="l",col=4,lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(b) The monetary circuit",ylab = 'Index (flow)',xlab = '',ylim=range(100,115))
...
legend("right",c("Initial finance","Final finance","Outstanding debt (right axis)"),  bty = "n", cex =1, lty=c(1,2,1), lwd=c(2,2,2,1), col = c(4,5,8), box.lwd=0)

#Figure 3c
plot(p[3,2:100],type="l",col=2,lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(c) Price level",ylab = '$',xlab = '',ylim=range(0.98,1.02))
legend("bottomright",c("Unit price of output"),  bty = "n", cex =1, lty=c(1), lwd=c(2), col = c(2), box.lwd=0)

#Figure 3d
plot(100*cw_r[3,2:100]/cw_r[1,2:100],type="l",col="purple",lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(d) Real consumption of workers",ylab = 'Index',xlab = '',ylim=range(100,115))
...
#Figure 4a
plot(100*y_r[4,2:100]/y_r[1,2:100],type="l",col=1,lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(a) Production, consumption, and investment (real)",ylab = 'Index',xlab = '',ylim=range(90,150))
...
legend("topright",c("Output","Workers' consumption","Capitalists' consumption","Investment"),  bty = "n", cex =1, lty=c(1,1,1,1), lwd=c(2,2,2,2), col = c(1,2,3,4), box.lwd=0)

#Figure 4b
plot(100*fin_i[4,2:100]/fin_i[1,2:100],type="l",col=4,lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(b) The monetary circuit",ylab = 'Index (flow)',xlab = '',ylim=range(98,130))
...
#Figure 4c
plot(p[4,2:100],type="l",col=2,lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(c) Price level",ylab = '$',xlab = '',ylim=range(1,1.1))
legend("right",c("Unit price of output"),  bty = "n", cex =1, lty=c(1), lwd=c(2), col = c(2), box.lwd=0)

#Figure 4d
plot(100*cw_r[4,2:100]/cw_r[1,2:100],type="l",col="purple",lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(d) Real consumption of workers",ylab = 'Index',xlab = '',ylim=range(93,115))
...
#Figure 5a
plot(100*y_r[5,2:100]/y_r[1,2:100],type="l",col=1,lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(a) Production, consumption, and investment (real)",ylab = 'Index',xlab = '',ylim=range(70,250))
...
legend("right",c("Output","Workers' consumption","Capitalists' consumption","Investment"),  bty = "n", cex =1, lty=c(1,1,1,1), lwd=c(2,2,2,2), col = c(1,2,3,4), box.lwd=0)

#Figure 5b
plot(100*fin_i[5,2:100]/fin_i[1,2:100],type="l",col=4,lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(b) The monetary circuit",ylab = 'Index (flow)',xlab = '',ylim=range(98,130))
...
#Figure 5c
plot(p[5,2:100],type="l",col=2,lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(c) Price level",ylab = '$',xlab = '',ylim=range(1,1.30))
legend("right",c("Unit price of output"),  bty = "n", cex =1, lty=c(1), lwd=c(2), col = c(2), box.lwd=0)

#Figure 5d
plot(100*cw_r[5,2:100]/cw_r[1,2:100],type="l",col="purple",lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(d) Real consumption of workers",ylab = 'Index',xlab = '',ylim=range(75,115))
...
#Figure 6a
plot(100*cw_r[5,2:100]/cw_r[1,2:100],type="l",col="purple",lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(a) Consumption of workers",ylab = 'Index',xlab = '',ylim=range(75,115))
...
legend("topright",c("Real","Nominal"),  bty = "n", cex =1, lty=c(1,2), lwd=c(2,2), col = c("purple","orange"), box.lwd=0)

#Figure 6b
plot((ydw[5,2:100]-cw[5,2:100])/p[5,2:100]-(ydw[1,2:100]-cw[1,2:100])/p[1,2:100],type="l",col="purple",lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(b) Saving of workers (difference with baseline)",ylab = '$',xlab = '',ylim=range(-3,2))
...
#Figure 6c
plot(100*cz_r[5,2:100]/cz_r[1,2:100],type="l",col="purple",lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(c) Consumption of capitalists",ylab = 'Index',xlab = '',ylim=range(100,300))
...
legend("bottomright",c("Real","Nominal"),  bty = "n", cex =1, lty=c(1,2), lwd=c(2,2), col = c("purple","orange"), box.lwd=0)

#Figure 6d
plot((ydz[5,2:100]-cz[5,2:100])/p[5,2:100]-(ydz[1,2:100]-cz[1,2:100])/p[1,2:100],type="l",col="purple",lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(d) Saving of capitalists (difference with baseline)",ylab = '$',xlab = '',ylim=range(0,6))
...
################################################################################
#Figure 7 - Exploitation of labour
layout(matrix(c(1,2), 1, 2, byrow = TRUE))
par(mar = c(5, 4, 4, 4) + 0.3)  

#Figure 7a
plot(slt[1,2:49], type="l",lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(a) Surplus-labour time",ylab = 'N',xlab = '',ylim=range(min(slt[1,2:nPeriods]),max(slt[5,2:49])))
...
legend("right",c("Baseline","Scenario 2","Scenario 3","Scenario 4","Scenario 5"),  bty = "n", cex =1, lty=c(1,1,1,1,1), lwd=c(2,2,2,2,2), col = c(1,2,3,4,"orange"), box.lwd=0)

#Figure 7b
plot(100*expl[1,2:49], type="l",lwd=2,lty=1,font.main=1,cex.main=1,cex.axis=1,cex.lab=1,main="(b) Exploitation rate",ylab = '%',xlab = '',ylim=range(100*min(expl[1,2:nPeriods]),100*max(expl[5,2:49])))
